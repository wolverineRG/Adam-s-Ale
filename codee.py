...
j=0
while True:
   Y_pred=regressor.predict([[696+b+j]])
   if super_s==1:
   ...
   min_demand=(Y_pred*0.083*1.3)+(Y_pred*0.087*1.7)+(Y_pred*0.0955*((2.1*0.46)+(2.4*0.54)))+(Y_pred*0.083*((2.3*0.46)+(3.3*0.54)))+(Y_pred*0.637*((2.7*0.46)+(3.7*0.54)))
   min_demand=float(min_demand)
   recommended_demand=((Y_pred*130)+Y_pred*0.083*1.3)+((Y_pred*130)+Y_pred*0.087*1.7)+((Y_pred*130)+Y_pred*0.0955*((2.1*0.46)+(2.4*0.54)))+((Y_pred*130)+Y_pred*0.083*((2.3*0.46)+(3.3*0.54)))+(Y_pred*((0.637*((2.7*0.46)+(3.7*0.54)))+130))
   
   recommended_demand=float(recommended_demand)
   recommended_demand=str(recommended_demand)
...
if(recommended_demand==supply):
       print("The water is adequate for the district" )
       
elif(recommended_demand>supply):
    #    print("The water to meet the needs can be met by collecting the rainfall having the surface area")
       ...
       if yfirst==0.0 or sa>100000:
           print("Supply the minimum water required i.e"+str(min_demand))
       else:
           print(("The water to meet the needs can be met by collecting the rainfall having the surface area")+s+"meter squared")

else:
    final_result=supply-recommended_demand
    print("The water in excess i.e",final_result,"Litres can be stored to be utilised for next month")
