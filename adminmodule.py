# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 22:20:51 2019
...
supply=input("please enter the amount of water allocated for a particular Region")
supply=float(supply)
...
#    print('\n demand for the ',j+1,'month \n')
   ...
   print(recommended_demand,"Liters")
...
if(recommended_demand==supply):
       print("Here the supply is equal to the demand"+str(supply))
       print(minimum_demand_0_141)
       print(minimum_demand_15_391)
       print(minimum_demand_40_691)
       print(minimum_demand_70_1001)
       
       labels = 'Age Group 0-14 yrs', 'Age group 15-39 yrs', 'Age Group 40-69 yrs', 'Age group 70-100 yrs'
       sizes = [minimum_demand_0_141, minimum_demand_15_391, minimum_demand_40_691, minimum_demand_70_1001]
       ...
       plt.savefig('public/images/image.png',dpi=300)
...
elif(recommended_demand>supply):
       
       calc=recommended_demand-supply
       calc=float(calc)
       
       sa=(calc/(yfirst*3.14*3.14)/1000000)
       
       if(yfirst==0.0 or sa>10000):
           total_min_demand=str(total_min_demand)
           print("Ëmergency situation the minimum water required for the zone is "+str(total_min_demand ))
           
           print(totalwater_rec_0_141)
           print(totalwater_rec_15_391)
           print(totalwater_rec_40_691)
           print(totalwater_rec_70_1001)
           
           labels = 'Age Group 0-14 yrs', 'Age group 15-39 yrs', 'Age Group 40-69 yrs', 'Age group 70-100 yrs'
           sizes = [totalwater_rec_0_141, totalwater_rec_15_391, totalwater_rec_40_691, totalwater_rec_70_1001]
           explode = (0.1, 0.1, 0.1, 0.1)  # only "explode" the 2n d slice (i.e. 'Hogs')
           ...
           calc=str(calc)
           print("The remaining need of water i.e "+str(calc)+" to meet the needs can be met by collecting the rainfall having the surface area "+str(sa)+"meter squared")
    ...
    pl=str(supply-recommended_demand)
    print("The water supply is in excess i.e " +str(pl)+" Litres can be stored to be utilised for next month")
